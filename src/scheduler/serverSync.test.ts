...
import ScheduleHandler, { defaultUserData } from './scheduleHandler'
...
describe('Ensure backup/sync works', () => {
   ...
   beforeEach(() => {
      getCloud.mockClear().mockImplementation(() => Promise.resolve(undefined))
      setCloud.mockClear().mockImplementation(() => Promise.resolve(undefined))
      getLocal.mockClear().mockImplementation(() => Promise.resolve(undefined))
      setLocal.mockClear().mockImplementation(() => Promise.resolve(undefined))
   })
