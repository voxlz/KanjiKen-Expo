            ...
            ([key, value]) => {
               ...
               const version = {
                  ...
                  features: value.Features
                     ...
                     : undefined,
                  issues: value.Issues ? getTable(value.Issues.raw) : undefined,
                  dictionary: dictIssueStr ? getTable(dictIssueStr) : undefined,
               }
   ...
   return (
      ...
      >
         <FlatList
            ...
            ListHeaderComponent={
               <View className="bg-white pt-4">
                  <View className="pt-10 flex-row justify-between bg-white w-full   px-8">
                     <Text className="text-xl font-noto-md">Changelog</Text>
                     <ExitBtn height={20} />
                  </View>
                  <HorRule opacity={0.2} />
               </View>
            ...
            renderItem={(item) => {
               const { version, issues, features, dictionary, description } =
                  item.item
               return (
                  <>
                     <View className="px-8">
                        ...
                        <BulletList text="Features" entries={features ?? []} />
                        <BulletList text="Bug Fixes" entries={issues ?? []} />
                        <BulletList
                           text="Dictionary"
                           entries={dictionary ?? []}
                        />
